...
class AssistantMessage(Message):
    ...
    def __init__(
        ...
        Args:
            ...
            tool_calls (Optional[List[ToolCalls]], optional): A list of tool calls generated by the model. Defaults to None.
        """
        ...
        if tool_calls is not None:
            ...
            for item in tool_calls:
                if not isinstance(item, ToolCalls):
                    raise ValueError("Tool calls must be ToolCalls objects")
